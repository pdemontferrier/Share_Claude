...
{
    public class VM_MH_Page31 : VM_MH_Generic
    {
        ...
        public VM_MH_Page31(IS_Settings settings, IS_Decoupe decoupe, IS_Notification notification)
        {
            _settings = settings;
            _decoupe = decoupe;
        ...
        private async void RefusalValidation()
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(_settings.GetDecoupeDetailDecoupeCommentaires()))
                {
                ...
                else
                {
                    ...
                    await _decoupe.DecoupeDetailRefusalAsync();
                }
            }
            finally
            {
