...
{
    public partial class MH_Page10 : UserControl
    {
        ...
        public MH_Page10()
        {
            ...
            this.DataContext = App.ServiceProvider.GetRequiredService<VM_MH_Page10>();
        ...
        private void StyleControls()
        {
            ...
            _controlStyler.StyleButton(MH_Admin, _icons.GetMH_Admin_Source());
            _controlStyler.StyleButton(MH_Home, _icons.GetMH_Home_Source());

            // Vérifier l'accès à la Page_97
            if (_navigation.CanNavigate("Page97"))
            {
                MH_Admin.Visibility = Visibility.Visible;
            }
        }
    }
}