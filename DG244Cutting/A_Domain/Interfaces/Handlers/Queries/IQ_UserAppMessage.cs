...
namespace DG244Cutting.A_Domain.Interfaces.Handlers.Queries
{
    ...
    /// dans le cadre du modèle CQRS.
    /// </summary>
    /// <remarks>
    /// <para>
    /// Contexte : consommé en lecture par les ViewModels (chaîne (2)) — en particulier le
    ...
    /// assemblage composite multi-sources. Utilisateurs cibles : ViewModels de
    /// présentation et UseCases orchestrateurs (consommation directe encadrée).
    /// </para>
    /// <para>
    /// Hérite du socle de lecture
    ...
    /// </para>
    /// <para>
    /// Objectif : fournir trois points d'entrée de requête traçables via CallChain,
    ...
    public interface IQ_UserAppMessage : IQ_Generic<UserAppMessage>
    {
        ...
        /// </para>
        /// <para>
        /// Objectif : permettre une requête CQRS dédiée, traçable et cohérente avec la
