...
namespace DG244Cutting.A_Domain.Interfaces.Handlers.Queries
{
    ...
    public interface IQ_UserApp : IQ_Generic<UserApp>
    {
        ...
        /// </para>
        /// <para>
        /// Objectif : fournir une projection traçable et robuste de l'identité d'un utilisateur,
        ...
        /// </para>
        /// <para>
        /// Objectif : permettre une requête CQRS dédiée, traçable et cohérente avec la CallChain. La
        ...
        /// </para>
        /// <para>
        /// Objectif : fournir une requête CQRS d'existence dédiée, traçable et cohérente avec la CallChain.
