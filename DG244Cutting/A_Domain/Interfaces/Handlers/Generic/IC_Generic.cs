...
namespace DG244Cutting.A_Domain.Interfaces.Handlers.Generic
{
    ...
    /// </para>
    /// <list type="bullet">
    ///   <item><description><c>CreatedAt</c> : positionné à la date courante lors de <see cref="HandleAddAsync"/>.</description></item>
    ///   <item><description><c>UpdatedAt</c> : positionné à la date courante lors de <see cref="HandleUpdateAsync"/>, <see cref="HandleUpdateRangeAsync"/> et <see cref="HandleSoftDeleteAsync"/>.</description></item>
