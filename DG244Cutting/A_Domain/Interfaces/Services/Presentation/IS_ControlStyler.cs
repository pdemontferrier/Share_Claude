...
namespace DG244Cutting.A_Domain.Interfaces.Services.Presentation
{
    public interface IS_ControlStyler
    {
        ...
        void StylePageOOControls(Border IdentificationBorder, Border IdBorder, Border PasswordBorder, PasswordBox PasswordInput, Button LoginButton, TextBlock LoginButtonText);
