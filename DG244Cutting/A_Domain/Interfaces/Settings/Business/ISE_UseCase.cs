...
{
    /// <summary>
    /// Contrat de l'état des sélections métier courantes partagé par l'application.
    /// </summary>
    /// <remarks>
    ...
    public interface ISE_UseCase : INotifyPropertyChanged
    {
        ...
        /// <c>0</c> sinon). Écriture exclusive via <see cref="SelectSeries"/> (positionnement) et <see cref="Reset"/> (remise à <c>0</c>).
        /// </remarks>
        ...
        /// atomiquement en filtrant les valeurs identiques. Le retrait de la barre relève de <see cref="ClearBar"/>
        /// et la réinitialisation globale de <see cref="Reset"/> ; aucune validation de positivité ni garde de
        /// cohérence amont n'est réalisée, la cohérence de la cascade reposant sur l'ordre d'appel des
        /// consommateurs.</para>
        /// </remarks>
        ...
        /// Les deux champs sont écrits en filtrant les valeurs identiques : seules les propriétés effectivement
        /// modifiées émettent une notification. L'opération ne comporte aucune précondition ; appelée alors
        /// qu'aucune barre n'est sélectionnée, elle est sans effet et ne constitue pas une erreur. Elle se distingue
        /// de <see cref="SelectSeries"/>, qui repositionne la série, et de <see cref="Reset"/>, qui réinitialise
        /// la cascade entière.</para>
        /// </remarks>
        void ClearBar();
        ...
        /// </summary>
        /// <remarks>
        /// <para>Contexte : Appelée lors des changements de contexte (retour sur la page racine, déconnexion,
        /// redémarrage logique).</para>
