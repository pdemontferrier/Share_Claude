...
public partial class ProductionCutPiece
{
    ...
    /// <summary>
    /// Indique si la découpe a été sélectionnée par le processus d’optimisation.
    /// </summary>
    public bool IsOptimized { get; set; }

    /// <summary>
    /// Indique si la barre nécessaire à la découpe a été approvisionnée.
    /// </summary>
    public bool IsBarSupplied { get; set; }

    /// <summary>
    /// Indique si un commentaire actif est associé à la découpe.
    /// </summary>
