...
public partial class vw_Source_ProductionFrameSash
{
    public int IdProductionChassis { get; set; }

    public short? ComponentNumber { get; set; }

    public short? FrameSashWidth { get; set; }

    public short? FrameSashHeight { get; set; }

    public string? OpeningTypeText { get; set; }

    public short? OpeningDirectionIndicator { get; set; }

    public string? SpecialOpeningTypeCode { get; set; }

    public string? AdjacentFramePartToSash { get; set; }

    public short? FrameSashWidthTenths { get; set; }

    public short? FrameSashHeightTenths { get; set; }
    ...
    public short? BeadsHeight { get; set; }

    public short? BeadsWidth { get; set; }
    ...
    public short? HardwareRabbetWidthTenths { get; set; }

    public short? HardwareRabbetHeightTenths { get; set; }
