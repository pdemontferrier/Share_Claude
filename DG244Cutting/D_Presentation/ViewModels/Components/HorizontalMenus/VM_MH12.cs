...
namespace DG244Cutting.D_Presentation.ViewModels.Components.HorizontalMenus
{
    ...
    /// <see cref="DG244Cutting.D_Presentation.ViewModels.Pages.VM_Page12"/>
    /// de l'application DG244Cutting, exposant à la vue
    /// <see cref="DG244Cutting.D_Presentation.Views.Components.HorizontalMenus.MH12"/>
    ...
    /// <see cref="VM_MH12"/> n'expose aucun événement propre,
    ...
    /// </list>
    /// </remarks>
    public class VM_MH12 : VM_MH_Generic
    {
        ...
        /// <summary>
        /// Initialise une nouvelle instance de <see cref="VM_MH12"/>.
        /// </summary>
        /// <remarks>
        /// <para>Contexte :</para>
        ///
