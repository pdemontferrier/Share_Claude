...
namespace DG244Cutting.D_Presentation.ViewModels.Components.HorizontalMenus
{
    ...
    /// <see cref="DG244Cutting.D_Presentation.ViewModels.Pages.VM_Page02"/>
    /// de l'application DG244Cutting, exposant à la vue
    /// <see cref="DG244Cutting.D_Presentation.Views.Components.HorizontalMenus.MH02"/>
    ...
    /// <see cref="VM_MH02"/> n'expose aucun événement propre,
    ...
    /// </list>
    /// </remarks>
    public class VM_MH02 : VM_MH_Generic
    {
        ...
        /// <summary>
        /// Initialise une nouvelle instance de <see cref="VM_MH02"/>.
        /// </summary>
        /// <remarks>
        /// <para>Contexte :</para>
        ///
