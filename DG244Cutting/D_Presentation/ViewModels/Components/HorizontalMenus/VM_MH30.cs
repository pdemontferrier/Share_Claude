...
namespace DG244Cutting.D_Presentation.ViewModels.Components.HorizontalMenus
{
    ...
    /// <see cref="DG244Cutting.D_Presentation.ViewModels.Pages.VM_Page30"/>
    /// de l'application DG244Cutting, exposant à la vue
    /// <see cref="DG244Cutting.D_Presentation.Views.Components.HorizontalMenus.MH30"/>
    ...
    /// <see cref="VM_MH30"/> n'expose aucun événement propre,
    ...
    /// </list>
    /// </remarks>
    public class VM_MH30 : VM_MH_Generic
    {
        ...
        /// <summary>
        /// Initialise une nouvelle instance de <see cref="VM_MH30"/>.
        /// </summary>
        /// <remarks>
        /// <para>Contexte :</para>
        ///
