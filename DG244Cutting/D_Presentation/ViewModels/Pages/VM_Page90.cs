...
namespace DG244Cutting.D_Presentation.ViewModels.Pages
{
    ...
    ///
    /// <para>La clé <c>P90_00</c> exposée par le présent ViewModel
    /// matérialise la convention selon laquelle, pour toute page de la
    /// série 10-90 de l'application DG244Cutting, la clé <c>_00</c> du
    ...
    /// n'est pas présente : <see cref="VM_Page90"/> n'expose aucun
    ...
    public class VM_Page90 : VM_Page_Generic
    {
        ...
        /// résolution de la clé <c>P90_00</c> échouerait silencieusement
        /// — auquel cas <c>SR_Dictionary</c> retourne la valeur de repli
        /// <c>[P90_00] not found</c> qui sera affectée par
        ...
        /// <summary>
        /// Obtient le nom multilingue de la page <c>Page90</c>, miroir du
        /// libellé associé à la clé <c>P90_00</c> dans le dictionnaire de
        /// langue actif.
        /// </summary>
        /// <value>
        /// Chaîne localisée résolue à partir du dictionnaire de langue
        /// actif. En cas de clé absente, <c>SR_Dictionary</c> retourne la
        /// valeur de repli <c>[P90_00] not found</c> conformément à
        /// R-4.11.6 du 0231.
        /// </value>
        /// <remarks>
        /// <para>Contexte : Propriété bindable consommée par la vue
        /// <see cref="DG244Cutting.D_Presentation.Views.Pages.Page90"/>
        ...
        /// présent ViewModel, la clé <c>P90_00</c> désigne nominalement
        ...
        /// <summary>
        /// Initialise une nouvelle instance de <see cref="VM_Page90"/>.
        /// </summary>
        /// <remarks>
        ...
        /// multilingue affiché par la page <c>Page90</c> à partir de la
        /// clé <c>P90_00</c> du dictionnaire de langue actif et
        ...
        /// session. La clé <c>P90_00</c> matérialise la convention
        /// <c>PXX_00 = nom de la page</c> introduite par le présent
        /// ViewModel pour la série 10-90 de l'application
        /// DG244Cutting.</para>
        ...
        /// repli <c>[P90_00] not found</c>, sans interruption ni
        ...
        {
            PageName = _dictionary.GetText(callChain, "P90_00");
        }
