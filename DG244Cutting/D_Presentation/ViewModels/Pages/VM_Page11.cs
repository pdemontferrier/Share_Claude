...
namespace DG244Cutting.D_Presentation.ViewModels.Pages
{
    ...
    /// et conditionne la cohérence des futures Page11 → Page80 ; son
    ...
    public class VM_Page11 : VM_Page_Generic
    {
        ...
        /// <summary>
        /// Obtient le nom multilingue de la page <c>Page11</c>, miroir du
        ...
        /// multilingue affiché par la page <c>Page11</c> à partir de la
        ...
        protected override void LoadLabels(string caller)
        {
            ...
            PageName = _dictionary.GetText(callChain, "P11_00");
        }
