...
namespace DG244Cutting.D_Presentation.ViewModels.Pages
{
    ...
    ///
    /// <para>La clé <c>P60_00</c> exposée par le présent ViewModel
    ...
    public class VM_Page60 : VM_Page_Generic
    {
        ...
        /// résolution de la clé <c>P60_00</c> échouerait silencieusement
        /// — auquel cas <c>SR_Dictionary</c> retourne la valeur de repli
        /// <c>[P60_00] not found</c> qui sera affectée par
        ...
        /// <summary>
        /// Obtient le nom multilingue de la page <c>Page60</c>, miroir du
        /// libellé associé à la clé <c>P60_00</c> dans le dictionnaire de
        /// langue actif.
        /// </summary>
        /// <value>
        /// Chaîne localisée résolue à partir du dictionnaire de langue
        /// actif. En cas de clé absente, <c>SR_Dictionary</c> retourne la
        /// valeur de repli <c>[P60_00] not found</c> conformément à
        /// R-4.11.6 du 0231.
        /// </value>
        /// <remarks>
        /// <para>Contexte : Propriété bindable consommée par la vue
        /// <see cref="DG244Cutting.D_Presentation.Views.Pages.Page60"/>
        ...
        /// présent ViewModel, la clé <c>P60_00</c> désigne nominalement
        ...
        /// <summary>
        /// Initialise une nouvelle instance de <see cref="VM_Page60"/>.
        /// </summary>
        /// <remarks>
        ...
        /// multilingue affiché par la page <c>Page60</c> à partir de la
        /// clé <c>P60_00</c> du dictionnaire de langue actif et
        ...
        /// session. La clé <c>P60_00</c> matérialise la convention
        ...
        /// repli <c>[P60_00] not found</c>, sans interruption ni
        ...
        {
            PageName = _dictionary.GetText(callChain, "P60_00");
        }
