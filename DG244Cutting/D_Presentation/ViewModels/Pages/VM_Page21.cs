...
namespace DG244Cutting.D_Presentation.ViewModels.Pages
{
    ...
    /// n'est pas présente : <see cref="VM_Page21"/> n'expose aucun
    ...
    public class VM_Page21 : VM_Page_Generic
    {
        ...
        /// <summary>
        /// Obtient le nom multilingue de la page <c>Page21</c>, miroir du
        ...
        /// <see cref="DG244Cutting.D_Presentation.Views.Pages.Page21"/>
        ...
        /// <summary>
        /// Initialise une nouvelle instance de <see cref="VM_Page21"/>.
        /// </summary>
        /// <remarks>
        ...
        /// multilingue affiché par la page <c>Page21</c> à partir de la
        ...
        protected override void LoadLabels(string caller)
        {
            ...
            PageName = _dictionary.GetText(callChain, "P21_00");
        }
