...
namespace DG244Cutting.D_Presentation.ViewModels.Pages
{
    ...
    ///
    /// <para>La clé <c>P10_00</c> exposée par le présent ViewModel
    ...
    /// n'est pas présente : <see cref="VM_Page10"/> n'expose aucun
    ...
    public class VM_Page10 : VM_Page_Generic
    {
        ...
        /// résolution de la clé <c>P10_00</c> échouerait silencieusement
        /// — auquel cas <c>SR_Dictionary</c> retourne la valeur de repli
        /// <c>[P10_00] not found</c> qui sera affectée par
        ...
        /// valeur de repli <c>[P10_00] not found</c> conformément à
        /// R-4.11.6 du 0231.
        /// </value>
        /// <remarks>
        ...
        /// présent ViewModel, la clé <c>P10_00</c> désigne nominalement
        ...
        /// <summary>
        /// Initialise une nouvelle instance de <see cref="VM_Page10"/>.
        /// </summary>
        /// <remarks>
        ...
        /// multilingue affiché par la page <c>Page10</c> à partir de la
        /// clé <c>P10_00</c> du dictionnaire de langue actif et
        ...
        /// session. La clé <c>P10_00</c> matérialise la convention
        ...
        /// repli <c>[P10_00] not found</c>, sans interruption ni
