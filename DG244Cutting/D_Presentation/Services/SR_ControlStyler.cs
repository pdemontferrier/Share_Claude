...
namespace DG244Cutting.D_Presentation.Services
{
    ...
    public class SR_ControlStyler : IS_ControlStyler
    {
        ...
        public void StylePageOOControls(Border IdentificationBorder, Border IdBorder, Border PasswordBorder, PasswordBox PasswordInput, Button LoginButton, TextBlock LoginButtonText)
                                => ControlStyler.StylePageOOControls(IdentificationBorder, IdBorder, PasswordBorder, PasswordInput, LoginButton, LoginButtonText);
