...
{
    /// <summary>
    /// Vue WPF du menu horizontal <c>MH11</c> de l'application
    ...
    ///   XAML est portée par <c>MH11.xaml</c> et se conforme au
    ...
    ///   sur <see cref="VM_MH_Generic.MenuCommand"/>, car MH11
    ...
    /// </list>
    /// </remarks>
    public partial class MH11 : MH_Generic
    {
        ...
        /// de la class.</para>
        /// </remarks>
        private readonly VM_MH11 _viewModel;
        ...
        /// <summary>
        /// Initialise une nouvelle instance de <see cref="MH11"/>.
        /// </summary>
        /// <remarks>
        /// <para>Contexte :</para>
        ///
        ...
        public MH11()
        {
            _viewModel = App.ServiceProvider.GetRequiredService<VM_MH11>();
