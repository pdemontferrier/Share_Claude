...
{
    /// <summary>
    /// Vue WPF du menu horizontal <c>MH70</c> de l'application
    ...
    /// conformément à R-4.4.70 du 0231 (la classe n'expose aucune
    ...
    ///   XAML est portée par <c>MH70.xaml</c> et se conforme au
    ...
    ///   sur <see cref="VM_MH_Generic.MenuCommand"/>, car MH70
    ...
    /// </list>
    /// </remarks>
    public partial class MH70 : MH_Generic
    {
        ...
        /// de la class.</para>
        /// </remarks>
        private readonly VM_MH70 _viewModel;
        ...
        /// <summary>
        /// Initialise une nouvelle instance de <see cref="MH70"/>.
        /// </summary>
        /// <remarks>
        /// <para>Contexte :</para>
        ///
        ...
        public MH70()
        {
            _viewModel = App.ServiceProvider.GetRequiredService<VM_MH70>();
