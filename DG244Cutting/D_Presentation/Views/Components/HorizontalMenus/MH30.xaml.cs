...
{
    /// <summary>
    /// Vue WPF du menu horizontal <c>MH30</c> de l'application
    ...
    /// conformément à R-4.4.30 du 0231 (la classe n'expose aucune
    ...
    ///   XAML est portée par <c>MH30.xaml</c> et se conforme au
    ...
    ///   sur <see cref="VM_MH_Generic.MenuCommand"/>, car MH30
    ...
    /// </list>
    /// </remarks>
    public partial class MH30 : MH_Generic
    {
        ...
        /// de la class.</para>
        /// </remarks>
        private readonly VM_MH30 _viewModel;
        ...
        /// <summary>
        /// Initialise une nouvelle instance de <see cref="MH30"/>.
        /// </summary>
        /// <remarks>
        /// <para>Contexte :</para>
        ///
        ...
        public MH30()
        {
            _viewModel = App.ServiceProvider.GetRequiredService<VM_MH30>();
