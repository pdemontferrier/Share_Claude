...
{
    /// <summary>
    /// Vue WPF du menu horizontal <c>MH13</c> de l'application
    ...
    ///   XAML est portée par <c>MH13.xaml</c> et se conforme au
    ...
    ///   sur <see cref="VM_MH_Generic.MenuCommand"/>, car MH13
    ...
    /// </list>
    /// </remarks>
    public partial class MH13 : MH_Generic
    {
        ...
        /// de la class.</para>
        /// </remarks>
        private readonly VM_MH13 _viewModel;
        ...
        /// <summary>
        /// Initialise une nouvelle instance de <see cref="MH13"/>.
        /// </summary>
        /// <remarks>
        /// <para>Contexte :</para>
        ///
        ...
        public MH13()
        {
            _viewModel = App.ServiceProvider.GetRequiredService<VM_MH13>();
