...
{
    /// <summary>
    /// Vue WPF du menu horizontal <c>MH12</c> de l'application
    ...
    /// conformément à R-4.4.12 du 0231 (la classe n'expose aucune
    ...
    ///   XAML est portée par <c>MH12.xaml</c> et se conforme au
    ...
    ///   sur <see cref="VM_MH_Generic.MenuCommand"/>, car MH12
    ...
    /// </list>
    /// </remarks>
    public partial class MH12 : MH_Generic
    {
        ...
        /// de la class.</para>
        /// </remarks>
        private readonly VM_MH12 _viewModel;
        ...
        /// <summary>
        /// Initialise une nouvelle instance de <see cref="MH12"/>.
        /// </summary>
        /// <remarks>
        /// <para>Contexte :</para>
        ///
        ...
        public MH12()
        {
            _viewModel = App.ServiceProvider.GetRequiredService<VM_MH12>();
