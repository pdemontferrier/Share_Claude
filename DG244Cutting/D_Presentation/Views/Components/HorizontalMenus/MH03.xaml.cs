...
{
    /// <summary>
    /// Vue WPF du menu horizontal <c>MH03</c> de l'application
    ...
    /// conformément à R-4.4.02 du 0231 (la classe n'expose aucune
    ...
    ///   XAML est portée par <c>MH03.xaml</c> et se conforme au
    ...
    ///   sur <see cref="VM_MH_Generic.MenuCommand"/>, car MH03
    ...
    /// </list>
    /// </remarks>
    public partial class MH03 : MH_Generic
    {
        ...
        /// de la class.</para>
        /// </remarks>
        private readonly VM_MH03 _viewModel;
        ...
        /// <summary>
        /// Initialise une nouvelle instance de <see cref="MH03"/>.
        /// </summary>
        /// <remarks>
        /// <para>Contexte :</para>
        ///
        ...
        public MH03()
        {
            _viewModel = App.ServiceProvider.GetRequiredService<VM_MH03>();
