...
{
    /// <summary>
    /// Vue WPF du menu horizontal <c>MH02</c> de l'application
    ...
    ///   XAML est portée par <c>MH02.xaml</c> et se conforme au
    ...
    ///   sur <see cref="VM_MH_Generic.MenuCommand"/>, car MH02
    ...
    /// </list>
    /// </remarks>
    public partial class MH02 : MH_Generic
    {
        ...
        /// de la class.</para>
        /// </remarks>
        private readonly VM_MH02 _viewModel;
        ...
        /// <summary>
        /// Initialise une nouvelle instance de <see cref="MH02"/>.
        /// </summary>
        /// <remarks>
        /// <para>Contexte :</para>
        ///
        ...
        public MH02()
        {
            _viewModel = App.ServiceProvider.GetRequiredService<VM_MH02>();
