...
{
    /// <summary>
    /// Vue WPF du menu horizontal <c>MH90</c> de l'application
    ...
    /// conformément à R-4.4.90 du 0231 (la classe n'expose aucune
    ...
    ///   XAML est portée par <c>MH90.xaml</c> et se conforme au
    ...
    ///   sur <see cref="VM_MH_Generic.MenuCommand"/>, car MH90
    ...
    /// </list>
    /// </remarks>
    public partial class MH90 : MH_Generic
    {
        ...
        /// de la class.</para>
        /// </remarks>
        private readonly VM_MH90 _viewModel;
        ...
        /// <summary>
        /// Initialise une nouvelle instance de <see cref="MH90"/>.
        /// </summary>
        /// <remarks>
        /// <para>Contexte :</para>
        ///
        ...
        public MH90()
        {
            _viewModel = App.ServiceProvider.GetRequiredService<VM_MH90>();
