...
{
    /// <summary>
    /// Vue WPF du menu horizontal <c>MH50</c> de l'application
    ...
    /// conformément à R-4.4.50 du 0231 (la classe n'expose aucune
    ...
    ///   XAML est portée par <c>MH50.xaml</c> et se conforme au
    ...
    ///   sur <see cref="VM_MH_Generic.MenuCommand"/>, car MH50
    ...
    /// </list>
    /// </remarks>
    public partial class MH50 : MH_Generic
    {
        ...
        /// de la class.</para>
        /// </remarks>
        private readonly VM_MH50 _viewModel;
        ...
        /// <summary>
        /// Initialise une nouvelle instance de <see cref="MH50"/>.
        /// </summary>
        /// <remarks>
        /// <para>Contexte :</para>
        ///
        ...
        public MH50()
        {
            _viewModel = App.ServiceProvider.GetRequiredService<VM_MH50>();
