...
{
    /// <summary>
    /// Vue WPF du menu horizontal <c>MH98</c> de l'application
    ...
    /// conformément à R-4.4.98 du 0231 (la classe n'expose aucune
    ...
    ///   XAML est portée par <c>MH98.xaml</c> et se conforme au
    ...
    ///   sur <see cref="VM_MH_Generic.MenuCommand"/>, car MH98
    ...
    /// </list>
    /// </remarks>
    public partial class MH98 : MH_Generic
    {
        ...
        /// de la class.</para>
        /// </remarks>
        private readonly VM_MH98 _viewModel;
        ...
        /// <summary>
        /// Initialise une nouvelle instance de <see cref="MH98"/>.
        /// </summary>
        /// <remarks>
        /// <para>Contexte :</para>
        ///
        ...
        public MH98()
        {
            _viewModel = App.ServiceProvider.GetRequiredService<VM_MH98>();
