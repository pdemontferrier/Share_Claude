...
{
    /// <summary>
    /// Vue WPF du menu horizontal <c>MH80</c> de l'application
    ...
    /// conformément à R-4.4.80 du 0231 (la classe n'expose aucune
    ...
    ///   XAML est portée par <c>MH80.xaml</c> et se conforme au
    ...
    ///   sur <see cref="VM_MH_Generic.MenuCommand"/>, car MH80
    ...
    /// </list>
    /// </remarks>
    public partial class MH80 : MH_Generic
    {
        ...
        /// de la class.</para>
        /// </remarks>
        private readonly VM_MH80 _viewModel;
        ...
        /// <summary>
        /// Initialise une nouvelle instance de <see cref="MH80"/>.
        /// </summary>
        /// <remarks>
        /// <para>Contexte :</para>
        ///
        ...
        public MH80()
        {
            _viewModel = App.ServiceProvider.GetRequiredService<VM_MH80>();
