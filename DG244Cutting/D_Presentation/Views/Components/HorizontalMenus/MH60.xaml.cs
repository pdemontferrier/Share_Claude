...
{
    /// <summary>
    /// Vue WPF du menu horizontal <c>MH60</c> de l'application
    ...
    /// conformément à R-4.4.60 du 0231 (la classe n'expose aucune
    ...
    ///   XAML est portée par <c>MH60.xaml</c> et se conforme au
    ...
    ///   sur <see cref="VM_MH_Generic.MenuCommand"/>, car MH60
    ...
    /// </list>
    /// </remarks>
    public partial class MH60 : MH_Generic
    {
        ...
        /// de la class.</para>
        /// </remarks>
        private readonly VM_MH60 _viewModel;
        ...
        /// <summary>
        /// Initialise une nouvelle instance de <see cref="MH60"/>.
        /// </summary>
        /// <remarks>
        /// <para>Contexte :</para>
        ///
        ...
        public MH60()
        {
            _viewModel = App.ServiceProvider.GetRequiredService<VM_MH60>();
