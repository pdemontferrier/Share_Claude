...
namespace DG244Cutting.D_Presentation.Views.Pages
{
    ...
    ///   <see cref="VM_Page10"/> résolue au constructeur via
    ...
    ///   navigation, résolvant <see cref="VM_Page10"/> et l'affectant
    ...
    public partial class Page10 : Page_Generic
    {
        ...
        /// le type concret <see cref="VM_Page10"/> au code-behind,
        /// distinct du
        /// <see cref="System.Windows.FrameworkElement.DataContext"/>
        ...
        /// <list type="number">
        ///   <item><description>Résolution de <see cref="VM_Page10"/>
        ...
        ///   la propriété
        ///   <see cref="VM_Page10.PageName"/>.</description></item>
        /// </list>
        ...
        /// forme <c>Page10 &gt; OnLoadedHandler &gt; ApplyLayout</c>,
        ...
        ///   <see cref="VM_Page10.PageName"/> et la largeur conserve
