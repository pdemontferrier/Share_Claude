...
namespace DG244Cutting.D_Presentation.Views.Pages
{
    ...
    ///   <see cref="VM_Page60"/> résolue au constructeur via
    ...
    ///   navigation, résolvant <see cref="VM_Page60"/> et l'affectant
    ...
    /// </list>
    /// </remarks>
    public partial class Page60 : Page_Generic
    {
        ...
        /// le type concret <see cref="VM_Page60"/> au code-behind,
        /// distinct du
        /// <see cref="System.Windows.FrameworkElement.DataContext"/>
        ...
        /// </remarks>
        private readonly VM_Page60 _viewModel;
        ...
        /// <summary>
        /// Initialise une nouvelle instance de <see cref="Page60"/>.
        /// </summary>
        /// <remarks>
        ...
        /// <list type="number">
        ///   <item><description>Résolution de <see cref="VM_Page60"/>
        ...
        ///   la propriété
        ///   <see cref="VM_Page60.PageName"/>.</description></item>
        /// </list>
        ...
        public Page60()
        {
            _viewModel = App.ServiceProvider.GetRequiredService<VM_Page60>();
        ...
        /// forme <c>Page60 &gt; OnLoadedHandler &gt; ApplyLayout</c>,
        ...
        ///   <see cref="VM_Page60.PageName"/> et la largeur conserve
        ...
        /// <c>Page60 &gt; OnLoadedHandler &gt; ApplyLayout</c>.</param>
