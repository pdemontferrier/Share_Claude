...
namespace DG244Cutting.D_Presentation.Views.Pages
{
    ...
    ///   navigation, résolvant <see cref="VM_Page11"/> et l'affectant
    ...
    public partial class Page11 : Page_Generic
    {
        ...
        /// le type concret <see cref="VM_Page11"/> au code-behind,
        /// distinct du
        /// <see cref="System.Windows.FrameworkElement.DataContext"/>
        ...
        /// <list type="number">
        ///   <item><description>Résolution de <see cref="VM_Page11"/>
        ...
        ///   la propriété
        ///   <see cref="VM_Page11.PageName"/>.</description></item>
        /// </list>
        ...
        /// forme <c>Page11 &gt; OnLoadedHandler &gt; ApplyLayout</c>,
        ...
        ///   <see cref="VM_Page11.PageName"/> et la largeur conserve
