...
namespace DG244Cutting.D_Presentation.Views.Pages
{
    ...
    ///   navigation, résolvant <see cref="VM_Page01"/> et l'affectant
    ...
    public partial class Pagexx : Page_Generic
    {
        ...
        /// pour alimenter les bindings WPF à venir déclarés par
        /// <c>Page01.xaml</c>.
        /// </summary>
        /// <remarks>
        ...
        /// stylisation initiale du <c>Grid</c> central de la page.
        /// </summary>
        /// <remarks>
        ...
        /// forme <c>Page01 &gt; OnLoadedHandler &gt; ApplyLayout</c>,
        /// conformément au patron méthode publique de §4.5.1 du
        /// 0230.</para>
        /// <para>Objectif : Appliquer la stylisation visuelle du
        /// conteneur de page via le service <c>IS_ControlStyler</c>
        ...
        /// <see cref="Page_Generic.Find{T}(string)"/> : Le contrôle
        ...
        /// cas d'absence ou de cast invalide du contrôle XAML, la
