...
namespace DG244Cutting.D_Presentation.Views.Pages
{
    ...
    ///   <see cref="VM_Page50"/> résolue au constructeur via
    ...
    ///   navigation, résolvant <see cref="VM_Page50"/> et l'affectant
    ...
    /// </list>
    /// </remarks>
    public partial class Page50 : Page_Generic
    {
        ...
        /// le type concret <see cref="VM_Page50"/> au code-behind,
        /// distinct du
        /// <see cref="System.Windows.FrameworkElement.DataContext"/>
        ...
        /// <summary>
        /// Initialise une nouvelle instance de <see cref="Page50"/>.
        /// </summary>
        /// <remarks>
        ...
        /// <list type="number">
        ///   <item><description>Résolution de <see cref="VM_Page50"/>
        ...
        ///   la propriété
        ///   <see cref="VM_Page50.PageName"/>.</description></item>
        /// </list>
        ...
        /// forme <c>Page50 &gt; OnLoadedHandler &gt; ApplyLayout</c>,
        ...
        ///   <see cref="VM_Page50.PageName"/> et la largeur conserve
        ...
        /// <c>Page50 &gt; OnLoadedHandler &gt; ApplyLayout</c>.</param>
