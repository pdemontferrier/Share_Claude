...
namespace DG244Cutting.D_Presentation.Views.Pages
{
    ...
    ///   <see cref="VM_Page80"/> résolue au constructeur via
    ...
    ///   navigation, résolvant <see cref="VM_Page80"/> et l'affectant
    ...
    /// </list>
    /// </remarks>
    public partial class Page80 : Page_Generic
    {
        ...
        /// le type concret <see cref="VM_Page80"/> au code-behind,
        /// distinct du
        /// <see cref="System.Windows.FrameworkElement.DataContext"/>
        ...
        /// </remarks>
        private readonly VM_Page80 _viewModel;
        ...
        /// <summary>
        /// Initialise une nouvelle instance de <see cref="Page80"/>.
        /// </summary>
        /// <remarks>
        ...
        /// <list type="number">
        ///   <item><description>Résolution de <see cref="VM_Page80"/>
        ...
        ///   la propriété
        ///   <see cref="VM_Page80.PageName"/>.</description></item>
        /// </list>
        ...
        public Page80()
        {
            _viewModel = App.ServiceProvider.GetRequiredService<VM_Page80>();
        ...
        /// forme <c>Page80 &gt; OnLoadedHandler &gt; ApplyLayout</c>,
        ...
        ///   <see cref="VM_Page80.PageName"/> et la largeur conserve
        ...
        /// <c>Page80 &gt; OnLoadedHandler &gt; ApplyLayout</c>.</param>
