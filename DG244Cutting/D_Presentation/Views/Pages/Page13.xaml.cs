...
namespace DG244Cutting.D_Presentation.Views.Pages
{
    ...
    ///   <see cref="VM_Page13"/> résolue au constructeur via
    ...
    ///   navigation, résolvant <see cref="VM_Page13"/> et l'affectant
    ...
    /// </list>
    /// </remarks>
    public partial class Page13 : Page_Generic
    {
        ...
        /// le type concret <see cref="VM_Page13"/> au code-behind,
        /// distinct du
        /// <see cref="System.Windows.FrameworkElement.DataContext"/>
        ...
        /// </remarks>
        private readonly VM_Page13 _viewModel;
        ...
        /// <summary>
        /// Initialise une nouvelle instance de <see cref="Page13"/>.
        /// </summary>
        /// <remarks>
        ...
        /// <list type="number">
        ///   <item><description>Résolution de <see cref="VM_Page13"/>
        ...
        ///   la propriété
        ///   <see cref="VM_Page13.PageName"/>.</description></item>
        /// </list>
        ...
        public Page13()
        {
            _viewModel = App.ServiceProvider.GetRequiredService<VM_Page13>();
        ...
        /// forme <c>Page13 &gt; OnLoadedHandler &gt; ApplyLayout</c>,
        ...
        ///   <see cref="VM_Page13.PageName"/> et la largeur conserve
        ...
        /// <c>Page13 &gt; OnLoadedHandler &gt; ApplyLayout</c>.</param>
