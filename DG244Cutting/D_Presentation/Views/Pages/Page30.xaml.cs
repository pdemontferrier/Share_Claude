...
namespace DG244Cutting.D_Presentation.Views.Pages
{
    ...
    ///   <see cref="VM_Page30"/> résolue au constructeur via
    ...
    ///   navigation, résolvant <see cref="VM_Page30"/> et l'affectant
    ...
    public partial class Page30 : Page_Generic
    {
        ...
        /// le type concret <see cref="VM_Page30"/> au code-behind,
        /// distinct du
        /// <see cref="System.Windows.FrameworkElement.DataContext"/>
        ...
        /// <summary>
        /// Initialise une nouvelle instance de <see cref="Page30"/>.
        /// </summary>
        /// <remarks>
        ...
        /// <list type="number">
        ///   <item><description>Résolution de <see cref="VM_Page30"/>
        ...
        ///   la propriété
        ///   <see cref="VM_Page30.PageName"/>.</description></item>
        /// </list>
        ...
        /// forme <c>Page30 &gt; OnLoadedHandler &gt; ApplyLayout</c>,
        ...
        ///   <see cref="VM_Page30.PageName"/> et la largeur conserve
        ...
        /// <c>Page30 &gt; OnLoadedHandler &gt; ApplyLayout</c>.</param>
