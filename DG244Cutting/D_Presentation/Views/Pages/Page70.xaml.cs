...
namespace DG244Cutting.D_Presentation.Views.Pages
{
    ...
    ///   <see cref="VM_Page70"/> résolue au constructeur via
    ...
    ///   navigation, résolvant <see cref="VM_Page70"/> et l'affectant
    ...
    /// </list>
    /// </remarks>
    public partial class Page70 : Page_Generic
    {
        ...
        /// le type concret <see cref="VM_Page70"/> au code-behind,
        /// distinct du
        /// <see cref="System.Windows.FrameworkElement.DataContext"/>
        ...
        /// </remarks>
        private readonly VM_Page70 _viewModel;
        ...
        /// <summary>
        /// Initialise une nouvelle instance de <see cref="Page70"/>.
        /// </summary>
        /// <remarks>
        ...
        /// <list type="number">
        ///   <item><description>Résolution de <see cref="VM_Page70"/>
        ...
        ///   la propriété
        ///   <see cref="VM_Page70.PageName"/>.</description></item>
        /// </list>
        ...
        public Page70()
        {
            _viewModel = App.ServiceProvider.GetRequiredService<VM_Page70>();
        ...
        /// forme <c>Page70 &gt; OnLoadedHandler &gt; ApplyLayout</c>,
        ...
        ///   <see cref="VM_Page70.PageName"/> et la largeur conserve
        ...
        /// <c>Page70 &gt; OnLoadedHandler &gt; ApplyLayout</c>.</param>
