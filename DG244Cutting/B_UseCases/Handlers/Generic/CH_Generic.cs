...
namespace DG244Cutting.B_UseCases.Handlers.Generic
{
    ...
    /// <list type="bullet">
    ///   <item><description>
    ///     <c>CreatedAt</c> (<c>DateTime</c> ou <c>DateTime?</c>) : positionné à <c>DateTime.Now</c>
    ///     lors de <see cref="HandleAddAsync"/>. Non altéré lors des mises à jour ou du soft delete.
    ///   </description></item>
    ///   <item><description>
    ///     <c>UpdatedAt</c> (<c>DateTime</c> ou <c>DateTime?</c>) : positionné à <c>DateTime.Now</c>
    ...
    public class CH_Generic<T> : IC_Generic<T> where T : class
    {
        ...
        /// à la date courante, et enregistre l'événement correspondant dans l'Event Store.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        public async Task HandleAddAsync(string caller, T entity, CancellationToken ct = default)
        {
            ...
            try
            {
                ...
                // Positionnement de CreatedAt à la date courante.
        ...
        public async Task HandleUpdateAsync(string caller, T entity, CancellationToken ct = default)
        {
            ...
            try
            {
                ...
                // Positionnement de UpdatedAt à la date courante.
        ...
        /// <c>UpdatedAt</c> à la date courante sur chacune, et enregistre un événement
        ...
        /// <c>UpdatedAt</c> à la date courante sur l'entité, puis délègue la persistance
        ...
        /// <summary>
        /// Positionne la propriété <c>CreatedAt</c> à la date courante si elle existe sur
        ...
        private static void SetCreatedAtIfExists(T entity)
        {
            ...
            if (prop.PropertyType == typeof(DateTime))
                ...
                prop.SetValue(entity, (DateTime?)DateTime.Now);
        }

        /// <summary>
        /// Positionne la propriété <c>UpdatedAt</c> à la date courante si elle existe sur
        /// le type <typeparamref name="T"/> et est accessible en écriture.
        /// </summary>
        /// <remarks>
        /// <para>
