...
namespace Shared.Settings
{
    public static class CR_CommonSettings
    {
        ...
        public static FontFamily ApplicationFont = new FontFamily(new Uri("pack://application:,,,/Shared;component/"), "./Fonts/#Suisse Int'l");
        public static FontFamily ApplicationFontBold = new FontFamily(new Uri("pack://application:,,,/Shared;component/"), "./Fonts/#Suisse Int'l Bold");
