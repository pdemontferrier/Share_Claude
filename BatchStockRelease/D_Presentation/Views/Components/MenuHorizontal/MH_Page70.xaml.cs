...
{
    public partial class MH_Page70 : MH_Page_Generic
    {
        /// <summary>
        /// MH_Page70 — Menu horizontal de la page 70.
        ///
        /// <para><b>Contexte :</b> Ce menu est affiché sur la Page70. 
        ...
        /// </list>
        ///
        /// <para><b>Vue modèle associée :</b> <see cref="VM_MH_Page70"/></para>
        ...
        {
            InitializeComponent();
            DataContext = App._serviceProvider.GetRequiredService<VM_MH_Page70>();
        }
    }
}