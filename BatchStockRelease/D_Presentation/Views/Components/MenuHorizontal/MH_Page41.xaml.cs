...
{
    public partial class MH_Page41 : MH_Page_Generic
    {
        /// <summary>
        /// MH_Page41 — Menu horizontal de la page 41.
        ///
        /// <para><b>Contexte :</b> Ce menu est affiché sur la Page41. 
        ...
        /// </list>
        ///
        /// <para><b>Vue modèle associée :</b> <see cref="VM_MH_Page41"/></para>
        ...
        {
            InitializeComponent();
            DataContext = App._serviceProvider.GetRequiredService<VM_MH_Page41>();
        }
    }
}