...
{
    public partial class MH_Page60 : MH_Page_Generic
    {
        /// <summary>
        /// MH_Page60 — Menu horizontal de la page 60.
        ///
        /// <para><b>Contexte :</b> Ce menu est affiché sur la Page60. 
        ...
        /// </list>
        ///
        /// <para><b>Vue modèle associée :</b> <see cref="VM_MH_Page60"/></para>
        ...
        {
            InitializeComponent();
            DataContext = App._serviceProvider.GetRequiredService<VM_MH_Page60>();
        }
    }
}