...
{
    public partial class MH_Page40 : MH_Page_Generic
    {
        /// <summary>
        /// MH_Page40 — Menu horizontal de la page 40.
        ///
        /// <para><b>Contexte :</b> Ce menu est affiché sur la Page40. 
        ...
        /// </list>
        ///
        /// <para><b>Vue modèle associée :</b> <see cref="VM_MH_Page40"/></para>
        ...
        {
            InitializeComponent();
            DataContext = App._serviceProvider.GetRequiredService<VM_MH_Page40>();
        }
    }
}