...
{
    public partial class MH_Page33 : MH_Page_Generic
    {
    /// <summary>
    /// MH_Page33 — Menu horizontal de la page 33.
    ///
    /// <para><b>Contexte :</b> Ce menu est affiché sur la Page33. 
    ...
    /// </list>
    ///
    /// <para><b>Vue modèle associée :</b> <see cref="VM_MH_Page33"/></para>
    ...
    public MH_Page33()
        {
            InitializeComponent();
            DataContext = App._serviceProvider.GetRequiredService<VM_MH_Page33>();
        }
    }
}