...
{
    public class DP_DecoupeBarreWithBarDropToRelease : IR_DecoupeBarreWithBarDropToRelease
    {
        private readonly IDbContextFactory<GestStockContext> _contextFactory;
        public DP_DecoupeBarreWithBarDropToRelease(IDbContextFactory<GestStockContext> contextFactory)
        {
        ...
        /// </summary>
        public async Task<List<DTO_DecoupeBarreWithBarDropToRelease>> GetAsync(int decoupeLotId)
        {
            ...
            return await (
                ...
                select new DTO_DecoupeBarreWithBarDropToRelease
                {
                    Id = db.Id,
